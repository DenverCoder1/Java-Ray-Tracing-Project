...
public class RenderTests {
	...
	/**
	 * Test Bigger Cornell Box Custom Scene
	 */
	@Test
	public void bigCornellBoxTest() {
		Scene scene = new Scene("bigCornellBoxTest");
		Camera camera1 = new Camera(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
		...
		scene.geometries.add( //
				...
				new Sphere(new Point3D(15, 40, -50), 20) //
						...
						.setMaterial(new Material().setKD(0.2).setKS(0.3).setShininess(20).setKR(0.4)),
				// red sphere
				new Sphere(new Point3D(-10, -45, 60), 38) //
						.setEmission(new Color(java.awt.Color.RED)) //
						.setMaterial(new Material().setKD(0.5).setKS(0.5).setShininess(100)),
				// deep blue sphere 1
				new Sphere(new Point3D(-65, -70, 80), 20) //
						.setEmission(new Color(20, 30, 200)) //
						.setMaterial(new Material().setKD(0.3).setKS(0.2).setShininess(20).setKT(0)),
				// deep green sphere 2
				new Sphere(new Point3D(-55, -80, 220), 12) //
						.setEmission(new Color(0, 80, 0)) //
						.setMaterial(new Material().setKD(0.3).setKS(0.2).setShininess(20).setKT(0)),
				// reflective sphere 2
				new Sphere(new Point3D(50, -35, 194), 20) //
						.setEmission(new Color(30, 30, 30)) //
						.setMaterial(new Material().setKD(0.2).setKS(0.3).setShininess(20).setKR(0.4)),
				// green sphere
				new Sphere(new Point3D(26, -45, 270), 10) //
						.setEmission(new Color(java.awt.Color.GREEN)) //
						.setMaterial(new Material().setKD(0.4).setKS(0.3).setShininess(100).setKT(0.45)),
				// yellow sphere
				new Sphere(new Point3D(50, -42, 240), 4) //
						.setEmission(new Color(240, 240, 0)) //
						.setMaterial(new Material().setKD(0.4).setKS(0.3).setShininess(100).setKT(0.45)),
				// dark red sphere
				new Sphere(new Point3D(50, -10, 240), 8) //
						.setEmission(new Color(120, 4, 4)) //
						.setMaterial(new Material().setKD(0.3).setKS(0.2).setShininess(20).setKT(0)),
				// dark purple sphere
				new Sphere(new Point3D(30, -70, 250), 8) //
						.setEmission(new Color(100, 0, 100)) //
						.setMaterial(new Material().setKD(0.1).setKS(0.2).setShininess(40).setKT(0)),
				// reflective sphere 3
				new Sphere(new Point3D(0, -60, 380), 12) //
						.setEmission(new Color(30, 30, 30)) //
						.setMaterial(new Material().setKD(0.2).setKS(0.3).setShininess(20).setKR(0.4)),
				// red sphere 2
				new Sphere(new Point3D(-15, -70, 400), 10) //
						.setEmission(new Color(java.awt.Color.RED)) //
						.setMaterial(new Material().setKD(0.4).setKS(0.2).setShininess(25).setKT(0.5)),
				// deep blue sphere
				new Sphere(new Point3D(15, -70, 405), 6) //
						.setEmission(new Color(0, 0, 80)) //
						.setMaterial(new Material().setKD(0.4).setKS(0.3).setShininess(100).setKT(0.45)),
				// magenta sphere 2
				new Sphere(new Point3D(0, -80, 415), 6) //
						.setEmission(new Color(java.awt.Color.MAGENTA)) //
						.setMaterial(new Material().setKD(0.4).setKS(0.2).setShininess(80).setKT(0.1)),
				// white glass sphere
				new Sphere(new Point3D(50, -45, 550), 20) //
						.setEmission(new Color(55, 65, 65)) //
						.setMaterial(new Material().setKD(0.2).setKS(0.1).setShininess(20).setKT(0.65)),
				// bubble sphere
				new Sphere(new Point3D(-50, -65, 420), 30) //
						.setEmission(new Color(60, 75, 75)) //
						.setMaterial(new Material().setKD(0.1).setKS(0.1).setShininess(10).setKT(0.6)),
				// ceiling
				new Triangle(new Point3D(-500, 500, -100), new Point3D(500, 500, -100), new Point3D(0, 0, -300)) //
						.setEmission(new Color(200, 200, 200)) //
						.setMaterial(new Material().setKD(0.01).setKS(0.01).setShininess(10)), //
				...
				new Triangle(new Point3D(-20, 120, -250), new Point3D(20, 120, -250), new Point3D(40, 140, -242)) //
						...
						.setMaterial(new Material().setKS(1).setKD(1).setShininess(100)), //
				// ceiling light 2
				new Triangle(new Point3D(-60, 160, -234), new Point3D(-80, 180, -226), new Point3D(80, 180, -226)) //
						.setEmission(new Color(250, 250, 250)) //
						.setMaterial(new Material().setKS(1).setKD(1).setShininess(100)), //
				new Triangle(new Point3D(-60, 160, -234), new Point3D(60, 160, -234), new Point3D(80, 180, -226)) //
						.setEmission(new Color(250, 250, 250)) //
						.setMaterial(new Material().setKS(1).setKD(1).setShininess(100)), //
				// ceiling light 3
				new Triangle(new Point3D(-100, 200, -218), new Point3D(-120, 220, -210), new Point3D(120, 220, -210)) //
						.setEmission(new Color(250, 250, 250)) //
						.setMaterial(new Material().setKS(1).setKD(1).setShininess(100)), //
				new Triangle(new Point3D(-100, 200, -218), new Point3D(100, 200, -218), new Point3D(120, 220, -210)) //
						.setEmission(new Color(250, 250, 250)) //
						.setMaterial(new Material().setKS(1).setKD(1).setShininess(100)) //
		);
		...
		scene.lights.add( //
				new SpotLight(new Color(800, 400, 0), new Point3D(0, 135, -242), new Vector(0, -1, 0)) //
						.setKL(0.005).setKQ(0.000007));
		scene.lights.add( //
				new SpotLight(new Color(800, 400, 0), new Point3D(0, 175, -226), new Vector(0, -1, 0)) //
						.setKL(0.005).setKQ(0.000007));
		scene.lights.add( //
				new SpotLight(new Color(800, 400, 0), new Point3D(0, 215, -210), new Vector(0, -1, 0)) //
						.setKL(0.005).setKQ(0.000007));
